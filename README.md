...
- **Trips** — multi-day plans with outfits, extras, **events** (brunch, flight, beach…), notes, and days listed as weekday and date. Finished trips auto-move to **Past trips** after their last day (including older trips with no dates)
