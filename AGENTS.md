...
- Do not do browser verification (computer-use, screenshots, or demo videos) unless the user explicitly asks for it. Serving the app over HTTP and checking that key assets return HTTP 200 is enough to confirm the environment works.
